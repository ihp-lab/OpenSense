...
namespace OpenSense.Component.MediaPipe.NET {
    ...
    public static class FaceMeshConnectionConstants {
        ...
        public static readonly IReadOnlyCollection<ValueTuple<int, int>> Lips = new[]{
        ...
        public static readonly IReadOnlyCollection<ValueTuple<int, int>> LeftEye = new[]{
        ...
        public static readonly IReadOnlyCollection<ValueTuple<int, int>> LeftIris = new[]{
            (474, 475), (475, 476), (476, 477), (477, 474),
        };

        public static readonly IReadOnlyCollection<ValueTuple<int, int>> LeftEyebrow = new[]{
            (276, 283), (283, 282), (282, 295),
            (295, 285), (300, 293), (293, 334),
            (334, 296), (296, 336),
        };

        public static readonly IReadOnlyCollection<ValueTuple<int, int>> RightEye = new[]{
        ...
        public static readonly IReadOnlyCollection<ValueTuple<int, int>> RightEyebrow = new []{
            (46, 53), (53, 52), (52, 65), (65, 55),
            (70, 63), (63, 105), (105, 66), (66, 107),
        };

        public static readonly IReadOnlyCollection<ValueTuple<int, int>> RightIris = new[]{
            (469, 470), (470, 471), (471, 472), (472, 469),
        };

        public static readonly IReadOnlyCollection<ValueTuple<int, int>> FaceOval = new[]{
        ...
        public static readonly IReadOnlyCollection<ValueTuple<int, int>> Contours = 
            Lips
            .Concat(LeftEye)
            .Concat(LeftEyebrow)
            .Concat(RightEye)
        ...
        public static readonly IReadOnlyCollection<ValueTuple<int, int>> Irises = 
            LeftIris
            .Concat(RightIris)
            .ToArray();

        public static readonly IReadOnlyCollection<ValueTuple<int, int>> Eyebrows =
            LeftEyebrow
            .Concat(RightEyebrow)
            .ToArray();

        public static readonly IReadOnlyCollection<ValueTuple<int, int>> Tesselation = new[]{
