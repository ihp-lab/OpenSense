...
namespace OpenPose {
	...
	public static class OPOutputParser {
		...
		public static void ParseOutput(ref OpenPoseDatum datum, IntPtr[] ptrArray, int[] sizeArray, OutputType type){
			switch (type){
		...
		public static void ParseDatumsInfo(ref OpenPoseDatum datum, IntPtr[] ptrArray, int[] sizeArray){
        ...
        // Parse name
        public static void ParseName(ref OpenPoseDatum datum, IntPtr[] ptrArray, int[] sizeArray){
        ...
        // Parse poseKeypoints
		public static void ParsePoseKeypoints(ref OpenPoseDatum datum, IntPtr[] ptrArray, int[] sizeArray){
        ...
        // Parse poseIds
		public static void ParsePoseIds(ref OpenPoseDatum datum, IntPtr[] ptrArray, int[] sizeArray){
        ...
        // Parse poseScores
        public static void ParsePoseScores(ref OpenPoseDatum datum, IntPtr[] ptrArray, int[] sizeArray){
        ...
        // Parse poseHeatMaps
        public static void ParsePoseHeatMaps(ref OpenPoseDatum datum, IntPtr[] ptrArray, int[] sizeArray){
        ...
        // Parse handKeypoints
        public static void ParseHandKeypoints(ref OpenPoseDatum datum, IntPtr[] ptrArray, int[] sizeArray){
        ...
        public static void ParseHandRectangles(ref OpenPoseDatum datum, IntPtr[] ptrArray, int[] sizeArray){
        ...
        // Parse handHeatMaps
        public static void ParseHandHeatMaps(ref OpenPoseDatum datum, IntPtr[] ptrArray, int[] sizeArray){
        ...
        // Parse faceKeypoints
        public static void ParseFaceKeypoints(ref OpenPoseDatum datum, IntPtr[] ptrArray, int[] sizeArray){
        ...
        public static void ParseFaceRectangles(ref OpenPoseDatum datum, IntPtr[] ptrArray, int[] sizeArray){
        ...
        // Parse faceHeatMaps
        public static void ParseFaceHeatMaps(ref OpenPoseDatum datum, IntPtr[] ptrArray, int[] sizeArray){
        ...
        // Parse cvInputData
        public static void ParseImage(ref OpenPoseDatum datum, IntPtr[] ptrArray, int[] sizeArray){
