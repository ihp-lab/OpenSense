...
namespace OpenFaceInterop
{
	...
	public:
		...
		void DetectFacesHOG(List<System::Windows::Rect>^ o_regions, RawImage^ intensity, List<float>^ o_confidences)
		{
		...
		// Face detection using HOG-SVM classifier
		void DetectFacesHaar(List<System::Windows::Rect>^ o_regions, RawImage^ intensity, List<float>^ o_confidences)
		{
		...
		void DetectFacesMTCNN(List<System::Windows::Rect>^ o_regions, RawImage^ rgb_image, List<float>^ o_confidences)
		{
			std::vector<cv::Rect_<float> > regions_ocv;
			std::vector<float> confidences_std;
