 ...
 ***************************************************************************E*/
 ...
 cWaveSourceClone : reads PCM WAVE files (RIFF format)
...
#ifndef __WAVE_SOURCE_CLONE_HPP
#define __WAVE_SOURCE_CLONE_HPP

#include <core/smileCommon.hpp>
#include <core/dataSource.hpp>

#define COMPONENT_DESCRIPTION_CWAVESOURCECLONE "A clone of cWaveSource for testing."
#define COMPONENT_NAME_CWAVESOURCECLONE "cWaveSourceClone"
...
#undef class
class cWaveSourceClone : public cDataSource {
private:
	const char *filename;
	//long buffersize;
	FILE *filehandle;
...
public:
	...
	cWaveSourceClone(const char *_name);

	virtual ~cWaveSourceClone();
};

#endif // __WAVE_SOURCE_CLONE_HPP
