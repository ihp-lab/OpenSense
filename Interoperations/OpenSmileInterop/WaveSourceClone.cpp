...
#define MODULE "cWaveSourceClone"

SMILECOMPONENT_STATICS(cWaveSourceClone)

SMILECOMPONENT_REGCOMP(cWaveSourceClone) {
	SMILECOMPONENT_REGCOMP_INIT
	scname = COMPONENT_NAME_CWAVESOURCECLONE;
	sdescription = COMPONENT_DESCRIPTION_CWAVESOURCECLONE;
	...
	SMILECOMPONENT_MAKEINFO(cWaveSourceClone);
}

SMILECOMPONENT_CREATE(cWaveSourceClone)

//-----

cWaveSourceClone::cWaveSourceClone(const char *_name) :
	cDataSource(_name),
	filehandle(NULL),
	filename(NULL),
	//buffersize(2000),
...
void cWaveSourceClone::fetchConfig() {
...
int cWaveSourceClone::configureWriter(sDmLevelConfig &c) {
	negativestart = 0;
	int ret = 0;
...
int cWaveSourceClone::myConfigureInstance() {
...
int cWaveSourceClone::setupNewNames(long nEl) {
...
/*
int cWaveSourceClone::myFinaliseInstance()
{
...
int cWaveSourceClone::myTick(long long t) {
	if (isEOI()) {
...
cWaveSourceClone::~cWaveSourceClone() {
...
int cWaveSourceClone::readData(cMatrix *m) {
	if (eof) {
...
int cWaveSourceClone::readWaveHeader() {
