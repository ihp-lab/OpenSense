...
namespace OpenFaceInterop
{
	...
	public:
		...
		RecorderOpenFace(System::String^ in_filename, RecorderOpenFaceParameters^ parameters, System::String^ output_directory)
		{
		...
		void SetObservationVisualization(RawImage^ vis_image)
		{
		...
		void SetObservationHOG(bool success, RawImage^ aligned_face_image, int num_cols, int num_rows, int num_channels)
		{
