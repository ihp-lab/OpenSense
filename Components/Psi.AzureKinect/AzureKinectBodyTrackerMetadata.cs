...
namespace OpenSense.Components.Psi.AzureKinect {
    ...
    public class AzureKinectBodyTrackerMetadata : ConventionalComponentMetadata {
        ...
        public override string Description => "Azure Kinect body tracker. Requires outputs from Azure Kinect. The Azure Kinect Sensor component already has this tracker built-in.";
