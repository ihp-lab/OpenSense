...
namespace OpenSense.Components.Onnx {
    public class HeadGestureDetector : Subpipeline, IConsumerProducer<HeadPose, HeadGesture> {
        ...
        public HeadGestureDetector(Pipeline pipeline) : base(pipeline, nameof(HeadGestureDetector)) {
            ...
            // Define the outputs
            var enumOut = CreateOutputConnectorTo<HeadGesture>(pipeline, nameof(Out));
        ...
        public Emitter<HeadGesture> Out { get; private set; }
