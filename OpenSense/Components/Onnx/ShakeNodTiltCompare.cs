...
namespace OpenSense.Components.Onnx {
    ...
    /// </summary>
    public class ShakeNodTiltCompare: IProducer<HeadGesture> {
        ...
        public ShakeNodTiltCompare(Pipeline pipeline) {
            ...
            // Create the emitter.
            Out = pipeline.CreateEmitter<DataStructure.HeadGesture>(this, nameof(Out));
        ...
        /// </summary>
        public Emitter<HeadGesture> Out {
            get;
            private set;
        }
        private void ReceiveShake(float input, Envelope envelope) {
            ...
            if (max > 0.9) {
                switch (maxIndex) {
                    case 0:
                        result = HeadGesture.Shake;
                        break;
                    case 1:
                        result = HeadGesture.Nod;
                        break;
                    case 2:
                        result = HeadGesture.Tilt;
                        break;
                }
            }
