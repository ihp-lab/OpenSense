...
namespace OpenSense.Component.Biopac.Visualizer {
    ...
    /// </summary>
    public class DisplayBiopac : INotifyPropertyChanged {
        /// <summary>
        ...
        /// <summary>
        /// Update biopac method.
        /// </summary>
        /// <param name="biopacStr">The bio signal.</param>
        public void Update(List<string> biopacStr) {

            for (int i = 0; i < biopacStr.Count(); i += 1) {
                // Extract the 32-bit IEEE float sample from the byte array
                float audioSample = float.Parse(biopacStr[i]) / 2000.0f;
        ...
        private void UpdateEnergy(object sender, EventArgs e) {
            lock (this.energyLock) {
                ...
                for (int i = 0; i < EnergyBitmapWidth; ++i) {
                    ...
                    // Center bar vertically on image
                    var barRect = new Int32Rect(i, HalfImageHeight - (barHeight / 2), 1, 2);
